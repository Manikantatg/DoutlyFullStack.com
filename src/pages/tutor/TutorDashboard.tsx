...
const TutorDashboard: React.FC = () => {
  ...
  const upcomingSessions = [
    { student: 'Alice Johnson', subject: 'Mathematics', time: '2:00 PM - 3:00 PM', date: 'Today' },
    { student: 'Bob Smith', subject: 'Physics', time: '4:00 PM - 5:00 PM', date: 'Today' },
    { student: 'Carol Davis', subject: 'Chemistry', time: '10:00 AM - 11:00 AM', date: 'Tomorrow' },
  ];
                ...
                {upcomingSessions.map((session, index) => (
                  <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h3 className="text-sm font-medium text-gray-900">{session.student}</h3>
                        <p className="text-xs text-gray-600">{session.subject}</p>
                      </div>
                    </div>
                    <div className="text-right">
                      <p className="text-xs font-medium text-gray-900">{session.time}</p>
